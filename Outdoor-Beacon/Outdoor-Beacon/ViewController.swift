...
//        sceneLocationView.locationEstimateMethod = .coreLocationDataOnly
        ...
        //let pinCoordinate = CLLocationCoordinate2D(latitude: 42.3603, longitude: -71.0875)
        //let pinLocation = CLLocation(coordinate: pinCoordinate, altitude: 3.71)
        //let pinImage = UIImage(named: "pin")!
        //let pinLocationNode = LocationAnnotationNode(location: pinLocation, image: pinImage)
        //sceneLocationView.addLocationNodeWithConfirmedLocation(locationNode: pinLocationNode)
        
        // Add buildings
        //let buildingsCoordinate = CLLocationCoordinate2D(latitude: 42.3603, longitude: -71.0875)
        //let buildingsLocation = CLLocation(coordinate: buildingsCoordinate, altitude: 3.71)
        //let buildingsNode = LocationNode(location: buildingsLocation)
        //let buildingsScene = SCNScene(named: "campus_buildings.scn", inDirectory: "Models.scnassets", options: nil)
        //buildingsNode.addChildNode(buildingsScene!.rootNode)
        //sceneLocationView.sceneNode?.addChildNode(buildingsNode)
    ...
    @objc func updateInfoLabel() {
        ...
        if let bestEstimate = self.sceneLocationView.bestLocationEstimate(),
            ...
            //infoLabel.text!.append("best location estimate, position: \(bestEstimate.position), location: \(bestEstimate.location.coordinate), accuracy: \(bestEstimate.location.horizontalAccuracy), date: \(bestEstimate.location.timestamp)\n")
            
            //let currentLocation = sceneLocationView.currentLocation()
            //let translation = bestEstimate.translatedLocation(to: position)
            //infoLabel.text!.append("current position: \(position)\n")
            //infoLabel.text!.append("translation: \(translation)\n")
            //infoLabel.text!.append("translated location: \(currentLocation)\n")
        }
